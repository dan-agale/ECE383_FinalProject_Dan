...
HD_PWD='C:/Users/kaush/Documents/ECE383_Dan/Final_Project/Tests/IR_SENSOR_TEST_v1/ir_sensor_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ir_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ir_test.tcl -notrace
