...
HD_PWD='C:/Users/kaush/Documents/ECE383_Dan/Final_Project/Tests/IR_SENSOR_TEST_v1/ir_sensor_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ir_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ir_test.tcl
