...
HD_PWD='C:/Users/kaush/Documents/ECE383_Dan/Final_Project/Tests/PS2_MOUSE_TEST_v1/ps2_mouse_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mouse_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mouse_top_level.tcl
