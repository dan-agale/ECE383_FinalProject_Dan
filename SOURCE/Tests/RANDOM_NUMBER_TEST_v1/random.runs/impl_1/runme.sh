...
HD_PWD='C:/Users/kaush/Documents/ECE383_Dan/Final_Project/Tests/RANDOM_NUMBER_TEST_v1/random.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log randomNum.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source randomNum.tcl -notrace
