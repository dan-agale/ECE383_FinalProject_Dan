...
HD_PWD='C:/Users/kaush/Documents/ECE383_Dan/Final_Project/Tests/RANDOM_NUMBER_TEST_v1/random.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log randomNum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source randomNum.tcl
