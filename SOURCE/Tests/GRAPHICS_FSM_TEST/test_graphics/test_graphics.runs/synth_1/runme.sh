...
HD_PWD='C:/Users/kaush/Documents/ECE383_Dan/Final_Project/Tests/GRAPHICS_FSM_TEST/test_graphics/test_graphics.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log graphics.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source graphics.tcl
